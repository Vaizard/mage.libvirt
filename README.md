...
mkdir -p /var/lib/libvirt/images/kvm-win10
virt-install --name="kvm-win10" --os-type=windows --os-variant=win10 --network network=default,model=virtio --disk path=/var/lib/libvirt/images/kvm-win10/disk-c.qcow2,size=18,bus=virtio --disk path=/var/lib/libvirt/images/kvm-win10/share.qcow2,size=5,bus=virtio --disk path=/var/lib/libvirt/images/iso/Win10_1703_Czech_x64.iso,device=cdrom --cdrom=/var/lib/libvirt/images/iso/virtio-win.iso --graphics spice,listen=0.0.0.0 --ram=3072 --vcpus=2 --noautoconsole
...
virsh vol-resize /home/killua/kvm-win10.qcow2 19G # safe on powered down VM
